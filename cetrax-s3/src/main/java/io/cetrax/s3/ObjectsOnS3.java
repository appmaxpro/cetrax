...
import static io.cetrax.common.CommonPreconditions.checkString;
import static io.cetrax.common.ObjectsPreconditions.*;
...
public class ObjectsOnS3 extends AbstractBaseS3Namespaceable implements StreamingObjects {
    ...
    // cetrax-objects-<namespace>/<startTimestamp>-<endTimestamp>
    private static final String objectKeyPrefix = "cetrax-objects";
