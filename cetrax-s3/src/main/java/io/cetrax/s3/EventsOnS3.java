...
import static io.cetrax.common.EventsPreconditions.*;
...
public class EventsOnS3 extends AbstractBaseS3Namespaceable implements Events {
    ...
    private static final String defaultBufferDirectory = "cetrax-events-s3-buffer";
    private static final long defaultFlushIntervalSeconds = 60;
    private static final long defaultTimeoutSeconds = 60;

    private static final String dimensionKeyPayloadOffset = ".cetrax-payload-offset";
    private static final String dimensionKeyPayloadLength = ".cetrax-payload-length";
    ...
    // cetrax-events-<namespace>/<startTimestamp>-<endTimestamp>
    private static final String objectKeyPrefix = "cetrax-events";
    ...
    public EventsOnS3(final AmazonS3 s3Client,
        ...
        builder.withS3Client(this.s3Client)
                ...
                .withExecutorFactory(() -> Executors.newFixedThreadPool(
                        ...
                        new ThreadFactoryBuilder()
                                .setNameFormat("cetrax-s3-event-transfer-manager-" + this.bucketName + "-worker-%d")
                                .build()
                ));
        ...
        flushExecutorServices.computeIfAbsent(bucketName, unused -> {
            final ScheduledExecutorService scheduledExecutorService = Executors.newSingleThreadScheduledExecutor(
                    new ThreadFactoryBuilder().setNameFormat("cetrax-s3-buffer-flusher-" + this.bucketName + "-%d").build()
            );
    ...
    private static Logger initSiftingLogger() {
        ...
        final String loggerName = "cetrax-s3-events-sifting-logger";
    ...
    private List<Event> doGet(final String namespace,
        ...
        final ListeningExecutorService executorService = newListeningExecutor("cetrax-events-s3-get-%d");
    ...
    private Set<String> doMetadata(final String namespace,
        ...
        // parallel calls to s3
        final ListeningExecutorService executorService = newListeningExecutor("cetrax-events-s3-metadata-%d");
        final AtomicBoolean futureHasFailed = new AtomicBoolean(false);
    ...
    private List<Event> doDimension(final String namespace,
        ...
        final List<Event> results = new CopyOnWriteArrayList<>();
        // parallel calls to s3
        final ListeningExecutorService executorService = newListeningExecutor("cetrax-events-s3-dimension-%d");
        final AtomicBoolean futureHasFailed = new AtomicBoolean(false);
    ...
    private Set<String> getMatchingKeys(final String namespace, final long startTimestampMillis, final long endTimestampMillis)
        ...
        final ListeningExecutorService executorService = newListeningExecutor("cetrax-events-s3-get-matching-keys-%d");
        final AtomicBoolean futureHasFailed = new AtomicBoolean(false);
