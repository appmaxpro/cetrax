...
import io.cetrax.functions.Functions;
import io.cetrax.functions.FunctionsOnCetrax;
...
@Component
@Path("/functions")
@Tag(name = "Functions Resource", description = "Api for handling Cetrax functions")
public class FunctionsResource {
    ...
    @Autowired
    public FunctionsResource(final Cetrax cetrax) {
        this.cetrax = cetrax;
        this.functions = new FunctionsOnCetrax(cetrax);
    }
    ...
    private Response doExecute(final String namespace,
        ...
        try {
            final io.cetrax.functions.Context context =
                    new io.cetrax.functions.Context(this.cetrax, this.functions);
