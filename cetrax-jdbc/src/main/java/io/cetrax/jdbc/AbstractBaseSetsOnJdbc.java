...
import static io.cetrax.common.SetsPreconditions.*;
import static io.cetrax.jdbc.JdbcUtils.addParameters;
import static io.cetrax.jdbc.JdbcUtils.getPlaceholders;
import static io.cetrax.jdbc.JdbcUtils.quote;

public abstract class AbstractBaseSetsOnJdbc extends AbstractBaseCetraxOnJdbc implements Sets {
