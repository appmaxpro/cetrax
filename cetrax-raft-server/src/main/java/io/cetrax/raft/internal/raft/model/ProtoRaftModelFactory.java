...
package io.cetrax.raft.internal.raft.model;

import io.cetrax.raft.internal.raft.model.groupop.UpdateRaftGroupMembersOpOrBuilder;
import io.cetrax.raft.internal.raft.model.log.LogEntryOrBuilder;
import io.cetrax.raft.internal.raft.model.log.SnapshotChunkOrBuilder;
import io.cetrax.raft.internal.raft.model.log.SnapshotEntryOrBuilder;
import io.cetrax.raft.internal.raft.model.log.RaftGroupMembersViewOrBuilder;
import io.cetrax.raft.internal.raft.model.message.AppendEntriesFailureResponseOrBuilder;
import io.cetrax.raft.internal.raft.model.message.AppendEntriesRequestOrBuilder;
import io.cetrax.raft.internal.raft.model.message.AppendEntriesSuccessResponseOrBuilder;
import io.cetrax.raft.internal.raft.model.message.InstallSnapshotRequestOrBuilder;
import io.cetrax.raft.internal.raft.model.message.InstallSnapshotResponseOrBuilder;
import io.cetrax.raft.internal.raft.model.message.PreVoteRequestOrBuilder;
import io.cetrax.raft.internal.raft.model.message.PreVoteResponseOrBuilder;
import io.cetrax.raft.internal.raft.model.message.TriggerLeaderElectionRequestOrBuilder;
import io.cetrax.raft.internal.raft.model.message.VoteRequestOrBuilder;
import io.cetrax.raft.internal.raft.model.message.VoteResponseOrBuilder;
import io.cetrax.raft.internal.raft.model.persistence.RaftEndpointPersistentStateOrBuilder;
import io.cetrax.raft.internal.raft.model.persistence.RaftTermPersistentStateOrBuilder;
