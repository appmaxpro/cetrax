...
package io.cetrax.raft.internal.di;

import static com.google.inject.name.Names.named;

import com.google.inject.AbstractModule;
import com.google.inject.TypeLiteral;
import io.cetrax.raft.admin.proto.AdminServiceGrpc.AdminServiceImplBase;
import io.cetrax.raft.config.AfloatDBConfig;
import io.cetrax.raft.internal.lifecycle.ProcessTerminationLogger;
import io.cetrax.raft.internal.lifecycle.impl.ProcessTerminationLoggerImpl;
import io.cetrax.raft.internal.raft.AfloatDBClusterEndpointsPublisher;
import io.cetrax.raft.internal.raft.KVStoreStateMachine;
import io.cetrax.raft.internal.raft.RaftNodeReportSupplier;
import io.cetrax.raft.internal.raft.RaftNodeSupplier;
import io.cetrax.raft.internal.raft.RaftStoreSupplier;
import io.cetrax.raft.internal.raft.model.ProtoRaftModelFactory;
import io.cetrax.raft.internal.raft.model.ProtoStateStoreSerializer;
import io.cetrax.raft.internal.rpc.RaftRpcService;
import io.cetrax.raft.internal.rpc.RpcServer;
import io.cetrax.raft.internal.rpc.impl.AdminService;
import io.cetrax.raft.internal.rpc.impl.KVService;
import io.cetrax.raft.internal.rpc.impl.RaftRpcServiceImpl;
import io.cetrax.raft.internal.rpc.impl.RaftService;
import io.cetrax.raft.internal.rpc.impl.RpcServerImpl;
import io.cetrax.raft.kv.proto.KVServiceGrpc.KVServiceImplBase;
import io.cetrax.raft.raft.proto.RaftServiceGrpc.RaftServiceImplBase;
