...
import static io.cetrax.raft.internal.di.AfloatDBModule.CONFIG_KEY;
import static io.cetrax.raft.internal.di.AfloatDBModule.LOCAL_ENDPOINT_KEY;
import static io.cetrax.raft.internal.di.AfloatDBModule.RAFT_ENDPOINT_ADDRESSES_KEY;
import static io.cetrax.raft.internal.utils.Exceptions.runSilently;
import static io.cetrax.raft.internal.utils.Serialization.wrap;
import static io.cetrax.raft.internal.utils.Threads.nextThreadId;
...
import io.cetrax.raft.raft.proto.RaftResponse;
import io.cetrax.raft.raft.proto.RaftServiceGrpc;
import io.cetrax.raft.raft.proto.RaftServiceGrpc.RaftServiceStub;
