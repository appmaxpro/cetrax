...
package io.cetrax.raft.internal.rpc.impl;

import io.cetrax.raft.kv.proto.ClearRequest;
import io.cetrax.raft.kv.proto.ContainsRequest;
import io.cetrax.raft.kv.proto.DeleteRequest;
import io.cetrax.raft.kv.proto.GetRequest;
import io.cetrax.raft.kv.proto.KVServiceGrpc.KVServiceImplBase;
import io.cetrax.raft.kv.proto.KVResponse;
import io.cetrax.raft.kv.proto.PutRequest;
import io.cetrax.raft.kv.proto.RemoveRequest;
import io.cetrax.raft.kv.proto.ReplaceRequest;
import io.cetrax.raft.kv.proto.SetRequest;
import io.cetrax.raft.kv.proto.SizeRequest;
import io.cetrax.raft.raft.proto.SizeOp;
import io.cetrax.raft.raft.proto.PutOp;
import io.cetrax.raft.raft.proto.GetOp;
import io.cetrax.raft.raft.proto.RemoveOp;
import io.cetrax.raft.raft.proto.ReplaceOp;
import io.cetrax.raft.raft.proto.ClearOp;
import io.microraft.Ordered;
import io.grpc.stub.StreamObserver;
import io.microraft.RaftNode;

import static io.cetrax.raft.internal.di.AfloatDBModule.RAFT_NODE_SUPPLIER_KEY;
...
import static io.cetrax.raft.internal.utils.Exceptions.wrap;
...
public class KVService extends KVServiceImplBase {
    ...
    public void put(PutRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.PutResult>replicate(op)
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.PutResult> result, Throwable throwable) -> {
                    ...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setPutResult(io.cetrax.raft.kv.proto.PutResult.newBuilder()
    ...
    public void set(SetRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.PutResult>replicate(op)
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.PutResult> result, Throwable throwable) -> {
                    ...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setSetResult(io.cetrax.raft.kv.proto.SetResult.newBuilder()
    ...
    public void get(GetRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.GetResult>query(op,
                request.getMinCommitIndex() == -1 ? LINEARIZABLE : EVENTUAL_CONSISTENCY,
                Math.max(0, request.getMinCommitIndex()))
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.GetResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setGetResult(io.cetrax.raft.kv.proto.GetResult.newBuilder()
    ...
    public void contains(ContainsRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.GetResult>query(op,
                ...
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.GetResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        io.cetrax.raft.kv.proto.ContainsResult.Builder builder2 = io.cetrax.raft.kv.proto.ContainsResult
                                .newBuilder();
    ...
    public void delete(DeleteRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.RemoveResult>replicate(op)
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.RemoveResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setDeleteResult(io.cetrax.raft.kv.proto.DeleteResult.newBuilder()
    ...
    public void remove(RemoveRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.RemoveResult>replicate(builder.build())
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.RemoveResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        io.cetrax.raft.kv.proto.RemoveResult.Builder builder2 = io.cetrax.raft.kv.proto.RemoveResult
    ...
    public void replace(ReplaceRequest request, StreamObserver<KVResponse> responseObserver) {
        ...
        raftNode.<io.cetrax.raft.raft.proto.ReplaceResult>replicate(op)
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.ReplaceResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setReplaceResult(io.cetrax.raft.kv.proto.ReplaceResult.newBuilder()
                                        .setSuccess(result.getResult().getSuccess()).build())
                                .build());
                    } else {
                        responseObserver.onError(wrap(throwable));
    ...
    public void size(SizeRequest request, StreamObserver<KVResponse> responseObserver) {
        raftNode.<io.cetrax.raft.raft.proto.SizeResult>query(SizeOp.getDefaultInstance(),
                request.getMinCommitIndex() == -1 ? LINEARIZABLE : EVENTUAL_CONSISTENCY,
                Math.max(0, request.getMinCommitIndex()))
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.SizeResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setSizeResult(io.cetrax.raft.kv.proto.SizeResult.newBuilder()
    ...
    public void clear(ClearRequest request, StreamObserver<KVResponse> responseObserver) {
        raftNode.<io.cetrax.raft.raft.proto.ClearResult>replicate(ClearOp.getDefaultInstance())
                .whenComplete((Ordered<io.cetrax.raft.raft.proto.ClearResult> result, Throwable throwable) -> {
                    // TODO [basri] bottleneck. offload to IO thread...
                    if (throwable == null) {
                        responseObserver.onNext(KVResponse.newBuilder().setCommitIndex(result.getCommitIndex())
                                .setClearResult(io.cetrax.raft.kv.proto.ClearResult.newBuilder()
