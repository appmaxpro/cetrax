package io.cetrax.raft;

import com.typesafe.config.ConfigFactory;
import io.cetrax.raft.cluster.proto.AfloatDBClusterEndpoints;
import io.cetrax.raft.cluster.proto.AfloatDBClusterEndpointsRequest;
import io.cetrax.raft.cluster.proto.AfloatDBClusterEndpointsResponse;
import io.cetrax.raft.cluster.proto.AfloatDBClusterServiceGrpc;
import io.cetrax.raft.cluster.proto.AfloatDBClusterServiceGrpc.AfloatDBClusterServiceStub;
import io.cetrax.raft.config.AfloatDBConfig;
import io.cetrax.raft.config.AfloatDBEndpointConfig;
import io.cetrax.raft.internal.raft.model.AfloatDBEndpoint;
import io.cetrax.raft.raft.proto.GetOp;
import io.cetrax.raft.raft.proto.GetResult;
import io.cetrax.raft.raft.proto.PutOp;
import io.cetrax.raft.raft.proto.SizeOp;
import io.cetrax.raft.raft.proto.SizeResult;
import io.cetrax.raft.kv.proto.Val;
import io.cetrax.raft.admin.proto.AddRaftEndpointAddressRequest;
import io.cetrax.raft.admin.proto.AddRaftEndpointRequest;
import io.cetrax.raft.admin.proto.GetRaftNodeReportRequest;
import io.cetrax.raft.admin.proto.AdminServiceGrpc;
import io.cetrax.raft.admin.proto.AdminServiceGrpc.AdminServiceBlockingStub;
import io.cetrax.raft.admin.proto.RaftNodeReportProto;
import io.cetrax.raft.admin.proto.RemoveRaftEndpointRequest;
import io.cetrax.raft.admin.proto.RemoveRaftEndpointResponse;
import io.cetrax.raft.raft.proto.RaftEndpointProto;
...
import static io.cetrax.raft.utils.AfloatDBTestUtils.CONFIG_1;
import static io.cetrax.raft.utils.AfloatDBTestUtils.CONFIG_2;
import static io.cetrax.raft.utils.AfloatDBTestUtils.CONFIG_3;
import static io.cetrax.raft.utils.AfloatDBTestUtils.getAnyFollower;
import static io.cetrax.raft.utils.AfloatDBTestUtils.getFollowers;
import static io.cetrax.raft.utils.AfloatDBTestUtils.getRaftGroupMembers;
import static io.cetrax.raft.utils.AfloatDBTestUtils.getRaftNode;
import static io.cetrax.raft.utils.AfloatDBTestUtils.getTerm;
import static io.cetrax.raft.utils.AfloatDBTestUtils.waitUntilLeaderElected;
