...
public class CetraxFactory {
    private static final Logger logger = LoggerFactory.getLogger(CetraxFactory.class);
    private static Cetrax instance;

    /**
     * Get the instance of Cetrax services.
     *
     * @throws IOException any exception thrown from injected providers
     * @return an instance of Cetrax
     */
    public static Cetrax get() throws IOException {
        if (instance == null) {
            init();
        }
        return instance;
    ...
    private static synchronized void init() throws IOException {
        ...
        logger.info("initializing cetrax factory");
        ...
        logger.info("cetrax factory loaded '{}' objects, '{}' sets, and '{}' events providers",
                objects.size(),
                sets.size(),
                events.size()
        );

        // initialize the cetrax proxy instance
        instance = new CetraxProxy(objects, sets, events);
    }
    ...
    static class CetraxProxy implements Cetrax {
        private final Objects objects;
        private final Sets sets;
        private final Events events;

        CetraxProxy(final Map<String, Objects> objectsDelegates,
