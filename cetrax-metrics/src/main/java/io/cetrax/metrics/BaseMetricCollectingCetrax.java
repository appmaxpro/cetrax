...
public class BaseMetricCollectingCetrax {
    private static final Logger logger = LoggerFactory.getLogger(BaseMetricCollectingCetrax.class);
    private final MetricRegistry metrics;
    private final Object delegate;

    BaseMetricCollectingCetrax(final MetricRegistry metrics, final Object delegate) {
        this.metrics = metrics;
        this.delegate = delegate;
    }

    // collects timer metrics and uses the given function to transform the cetrax result into an integer for a histogram
