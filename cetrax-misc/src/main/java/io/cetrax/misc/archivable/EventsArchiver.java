...
package io.cetrax.misc.archivable;

import io.cetrax.Events;
import io.cetrax.Namespaceable;
import io.cetrax.misc.archivable.impl.ArchivableEvents;
...
public interface EventsArchiver extends Namespaceable {
    ...
    /**
     * Will retrieve all archived chunks between the provided timestamps and load them back into Cetrax.
     * <br><br>
