...
import static io.cetrax.common.CommonPreconditions.*;

public class FunctionsOnCetrax implements Functions {
    private static final Logger logger = LoggerFactory.getLogger(FunctionsOnCetrax.class);

    private final Cetrax cetrax;
    private final List<Executor> executors = new ArrayList<>();

    public FunctionsOnCetrax(final Cetrax cetrax) {
        this.cetrax = cetrax;
        initExecutors();
    }
    ...
    private void doCreate(final String namespace) throws IOException {
        ...
        this.cetrax.objects().create(functionNamespace);
    }
    ...
    private void doDrop(final String namespace) throws IOException {
        ...
        this.cetrax.objects().drop(functionNamespace);
    }
    ...
    private void doStore(final String namespace, final String function, final byte[] body) throws IOException {
        ...
        this.cetrax.objects().store(functionNamespace, function, body);
    }
    ...
    private byte[] doGet(final String namespace, final String function) throws IOException {
        ...
        return this.cetrax.objects().get(functionNamespace, function);
    }
    ...
    private void doDelete(final String namespace, final String function) throws IOException {
        ...
        this.cetrax.objects().delete(functionNamespace, function);
    }

    private Collection<String> doList(final String namespace) throws IOException {
        return this.cetrax.objects().keys(getFunctionNamespace(namespace), 0, -1);
    }
