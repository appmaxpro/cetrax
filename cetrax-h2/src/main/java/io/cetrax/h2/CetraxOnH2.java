...
public class CetraxOnH2 implements Cetrax {
    private final Objects objects;
    private final Sets sets;
    private final Events events;

    public CetraxOnH2(final String path) throws IOException {
        this.objects = new ObjectsOnH2(path);
        this.sets = new SetsOnH2(path);
        this.events = new EventsOnH2(path);
    }

    public CetraxOnH2(final DataSource dataSource) throws IOException {
